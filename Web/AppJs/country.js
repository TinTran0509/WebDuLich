var Country = function () {
    return {
        ...
        loadData: function (page) {
            $("#loading").show();
            AjaxService.POST("/Admin/Country/ListData", { page: page}, function (res) {
        ...
        onupdateposittion: function () {
            ...
            AjaxService.POST("/Admin/Country/UpdatePosition", { value: strValue }, function (res) {
        ...
        active: function (id) {
            ...
            swal({
                ...
                if (isConfirm) {
                    AjaxService.POST("/Admin/Country/ChangeStatus", { id: id }, function (res) {
                        self.pageIndex = 1;
                        self.loadData(self.pageIndex);
                        alertmsg.success(res.Messenger);
                    });
        ...
        onEditSuccess: function (res) {
            if (res.IsSuccess == true) {
                ...
                Country.loadData(parseInt(page));
                modal.hide();
            } else {
                alertmsg.error(res.Messenger);
            }
        ...
        onmultidelete: function () {
            ...
            if ($("table tbody").find("input[type=checkbox]:checked").length == 0) {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        AjaxService.POST("/Admin/Country/DeleteAll", { lstid: $("#hdfID").val() }, function (res) {
                            self.pageIndex = 1;
                            self.loadData(self.pageIndex);
                            alertmsg.success(res.Messenger);
                        });
